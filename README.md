...
4. Micro Insight (Monetization Strategy): Terdapat perbedaan model bisnis yang mencolok berdasarkan mode permainan. Saat dilakukan pemfilteran pada kategori Single-player, rentang harga "Murah" tetap menjadi andalan utama. Namun, saat beralih ke kategori Multi-player, dominasi bergeser drastis di mana game "Gratis" (Free-to-Play) memimpin pasar dengan menguasai 49% dari total distribusi.
